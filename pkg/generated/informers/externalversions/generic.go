...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericInformer, error) {
	...
	case v0alpha1.SchemeGroupVersion.WithResource("timeintervallists"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Notifications().V0alpha1().TimeIntervalLists().Informer()}, nil
