...
type Interface interface {
	...
	// TimeIntervalLists returns a TimeIntervalListInformer.
	TimeIntervalLists() TimeIntervalListInformer
}
...
// TimeIntervalLists returns a TimeIntervalListInformer.
func (v *version) TimeIntervalLists() TimeIntervalListInformer {
	return &timeIntervalListInformer{factory: v.factory, namespace: v.namespace, tweakListOptions: v.tweakListOptions}
}
